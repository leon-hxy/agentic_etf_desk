...
class Stage3CBacktestValidationTest(unittest.TestCase):
    ...
    def test_stage3c_updates_governance_state_after_internal_review(self) -> None:
        ...
        self.assertEqual(runner["status"], "ready")
        self.assertEqual(runner["current_minor_stage"], "Stage 3D")
        self.assertEqual(runner["current_task"], "ops/tasks/stage3d_strategy_evidence_report.md")
        self.assertEqual(runner["completed_minor_stages"], ["Stage 3A", "Stage 3B", "Stage 3C"])
        self.assertEqual(runner["remaining_minor_stages"], ["Stage 3D", "Stage 3E"])
        ...
        self.assertEqual(loop_state["current_stage"], "Stage 3C completed_internal_review")
        self.assertEqual(loop_state["stage3c_task_status"], "completed_internal_review")
        self.assertEqual(loop_state["next_minor_task"], "ops/tasks/stage3d_strategy_evidence_report.md")
        ...
        self.assertEqual(handoff["stage"], "Stage 3C completed_internal_review")
        self.assertEqual(handoff["stage3c_task_status"], "completed_internal_review")
        self.assertEqual(handoff["stage3_runner_current_minor_stage"], "Stage 3D")
