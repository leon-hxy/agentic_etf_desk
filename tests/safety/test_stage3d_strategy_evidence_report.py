...
class Stage3DStrategyEvidenceReportTest(unittest.TestCase):
    ...
    def test_stage3d_updates_governance_state_after_internal_review(self) -> None:
        ...
        self.assertEqual(runner["remaining_minor_stages"], ["Stage 3E"])
        ...
        self.assertEqual(loop_state["current_stage"], "Stage 3D completed_internal_review")
        self.assertEqual(loop_state["stage3d_task_status"], "completed_internal_review")
        self.assertEqual(loop_state["stage3_runner_current_minor_stage"], "Stage 3E")
        self.assertEqual(loop_state["stage3_runner_current_task"], "ops/tasks/stage3_major_review_package.md")
        ...
        self.assertEqual(handoff["stage"], "Stage 3D completed_internal_review")
        ...
        self.assertEqual(handoff["stage3_runner_current_task"], "ops/tasks/stage3_major_review_package.md")
