...
class Stage3DStrategyEvidenceReportTest(unittest.TestCase):
    ...
    def test_stage3d_updates_governance_state_after_internal_review(self) -> None:
        ...
        self.assertEqual(loop_state["current_stage"], "Stage 3 sample-data pipeline validation merged to main")
        ...
        self.assertEqual(handoff["stage"], "Stage 3 sample-data pipeline validation merged to main")
