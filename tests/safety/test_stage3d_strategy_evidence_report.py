...
class Stage3DStrategyEvidenceReportTest(unittest.TestCase):
    ...
    def test_stage3d_updates_governance_state_after_internal_review(self) -> None:
        ...
        self.assertEqual(loop_state["stage3_runner_current_minor_stage"], "Stage 3F.1")
        self.assertEqual(loop_state["stage3_runner_current_task"], "ops/tasks/stage3f1_review_target_commit_consistency.md")
        ...
        self.assertEqual(handoff["stage3_runner_current_minor_stage"], "Stage 3F.1")
        self.assertEqual(handoff["stage3_runner_current_task"], "ops/tasks/stage3f1_review_target_commit_consistency.md")
