...
class ProgramRunnerGovernanceTest(unittest.TestCase):
    ...
    def test_runner_state_enforces_autonomous_final_review_only_mode(self) -> None:
        ...
        expected_required = {
            ...
            "current_work_package": "Stage 4 WP4 monthly rebalance research ticket command output",
        ...
        self.assertEqual(state["stage4"]["last_completed_work_package"], "Stage 4 WP3 weekly report command output")
        self.assertEqual(state["stage4"]["last_internal_review"], "reports/internal_reviews/program/stage4_wp3_weekly_report_command_output.json")
        self.assertEqual(state["stage4"]["last_report"], "reports/program_runner/stage4_wp3_weekly_report_command_output_report.json")
    ...
    def test_program_runner_reconciliation_report_and_notification_preview_exist(self) -> None:
        ...
        self.assertIn("Stage 4 WP4 monthly rebalance research ticket command output", handoff_md)
