...
class ProgramRunnerGovernanceTest(unittest.TestCase):
    ...
    def test_runner_state_enforces_autonomous_final_review_only_mode(self) -> None:
        ...
        expected_required = {
            ...
            "current_work_package": "Stage 5 WP3 portfolio weight calculation",
        ...
        self.assertEqual(state["stage5"]["current_work_package"], "Stage 5 WP2 manual trades CSV import")
        self.assertEqual(
        ...
        self.assertEqual(state["stage5"]["last_completed_work_package"], "Stage 5 WP2 manual trades CSV import")
        self.assertEqual(state["stage5"]["last_internal_review"], "reports/internal_reviews/program/stage5_wp2_manual_trades_import.json")
        self.assertEqual(state["stage5"]["last_report"], "reports/program_runner/stage5_wp2_manual_trades_import_report.json")
    ...
    def test_program_runner_reconciliation_report_and_notification_preview_exist(self) -> None:
        ...
        self.assertEqual(
            ...
            "resume Stage 5 WP3 portfolio weight calculation",
        )
        self.assertEqual(
