...
class ProgramRunnerGovernanceTest(unittest.TestCase):
    ...
    def test_runner_state_enforces_autonomous_final_review_only_mode(self) -> None:
        ...
        expected_required = {
            ...
            "current_work_package": "Stage 6 WP5 Hermes/Feishu notification stability",
        ...
        self.assertEqual(state["stage5"]["current_work_package"], "Stage 5 WP6 adoption and rejection journal")
        self.assertEqual(
            ...
            [
                ...
                "stage5_wp6_adoption_rejection_journal",
            ],
        )
        self.assertEqual(state["stage5"]["last_completed_work_package"], "Stage 5 WP6 adoption and rejection journal")
        self.assertEqual(state["stage5"]["last_internal_review"], "reports/internal_reviews/program/stage5_wp6_adoption_rejection_journal.json")
        self.assertEqual(state["stage5"]["last_report"], "reports/program_runner/stage5_wp6_adoption_rejection_journal_report.json")
        ...
        self.assertEqual(state["stage6"]["current_work_package"], "Stage 6 WP5 Hermes/Feishu notification stability")
        self.assertEqual(
            state["stage6"]["completed_work_packages"],
            [
                "stage6_wp1_schedule_dry_runs",
                "stage6_wp2_error_recovery",
                "stage6_wp3_log_redaction",
                "stage6_wp4_public_repo_hygiene",
            ],
        )
        self.assertEqual(state["stage6"]["last_completed_work_package"], "Stage 6 WP4 public repo hygiene")
        self.assertEqual(state["stage6"]["last_internal_review"], "reports/internal_reviews/program/stage6_wp4_public_repo_hygiene.json")
        self.assertEqual(state["stage6"]["last_report"], "reports/program_runner/stage6_wp4_public_repo_hygiene_report.json")
    ...
    def test_program_runner_reconciliation_report_and_notification_preview_exist(self) -> None:
        ...
        self.assertEqual(
            ...
            "resume Stage 6 WP5 Hermes/Feishu notification stability",
        )
        self.assertEqual(
