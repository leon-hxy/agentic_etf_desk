...
CURRENT_STAGE = "Stage 3.1 WP2 real data quality and monthly panel completed_internal_review"
...
class Stage3FFeishuNotificationTest(unittest.TestCase):
    ...
    def test_runner_loop_handoff_and_review_request_record_stage3f1_after_notification(self) -> None:
        ...
        self.assertNotEqual(loop_state["review_target_commit"], REVIEW_TARGET_COMMIT)
